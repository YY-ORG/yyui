...
import { RestApiCfg, RestApi, Adminui } from '../../core';
...
export class SiteService {
    ...
    const api = this.restApiCfg.getRestApi("menu.roles");
		return  this.restApi.request(api.method, api.url, undefined, undefined,  this.userInfo.roles)
								.catch(e => {
									if (e.status === 401) {
